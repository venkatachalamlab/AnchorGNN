...
# folder_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/dataset/ZM9624_iou')
# folder_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/dataset/anchor_eval')
...
# graph_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/dataset/ZM9624')/('graph')
# graph_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/dataset/ZM9624')/('graph_mask')
# graph_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/dataset/ZM9624/graph_eval')
graph_path =  Path(folder_path)/('graph_mask')
...
# weights_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/run_test/run8/model/loss_train.pt')
weights_path = Path('/work/venkatachalamlab/Hang/00Neuron_tracking_version2/01version/run_test/run_mask/model/loss_train.pt')
nearby_search_num = 5
with_AM = False
...
method = 3 ## method of locating the neareast nodes
t_max = metadata['shape_t'] ## metadata['shape_t']
metadata['t_ref'] = t_initial_list
threshold = 0.6 ## threshold = 0.5 / 0.65 for method =2
